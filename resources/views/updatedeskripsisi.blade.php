                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{url('deskripsisi')}}"><i class="fa fa-circle-o"></i>Sekretariat Jenderal</a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{url('/deskripsisi')}}"><i class="fa fa-briefcase"></i> Sekretariat Jenderal</a></li>
        ...
        <section class="content">-->
                ...
                <section class="main-section">
                    ...
                    <div class="content">
                        ...
                        @endif -->
                        <form action="{{url('/updatedeskripsisi/update')}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="id_eselon1" value="{{$deskripsi_si->id_eselon1}}">
                            <input type="hidden" name="id" value="{{$deskripsi_si->id}}">
                            <div class="form-group">
                                <label for="nama_url">Nama URL:</label>
                                <input type="text" class="form-control" id="name_url" name="nama_url" placeholder="Nama Url" value="{{$deskripsi_si->nama_url}}">
                            </div>
                            <div class="form-group">
                                <label for="nama_eselon">Nama Eselon:</label>
                                <input type="text" class="form-control" id="nama_eselon" name="nama_eselon" value="{{$deskripsi_si->nama_eselon}}">
                            </div>
                            <div class="form-group">
                                <label for="deskripsi">Deskripsi:</label>
                                <textarea name="deskripsi" rows="5" class="form-control" id="deskripsi" placeholder="Deskripsi..">{{$deskripsi_si->deskripsi}}</textarea>
                            </div>
                            <!--<div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="status">Status:</label><br>
                                <select name="si_status" id="" class="form-control">
                                    @if($deskripsi_si->status == "1")
                    ...
                    <div class="form-group">
                        <span style="margin: 25px">
                            ...
                            <a href="{{url('/deskripsisi/1')}}" type="reset" class="btn btn-md btn-danger" onclick="return confirm('ingin melewatkan perubahan?');">Batal</a>
                        </span>
                    </div>
                    </form>
            </div>
