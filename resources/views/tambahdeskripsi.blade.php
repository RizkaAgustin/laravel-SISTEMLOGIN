            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{url('/deskripsi')}}"><i class="fa fa-briefcase"></i> Sekretariat Jenderal</a></li>
        ...
        <section class="content">-->
                ...
                <section class="main-section">
                    ...
                    <div class="content">
                        ...
                        @endif
                        <form action="/tambahdeskripsi/create" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="nama_url">Nama URL:</label>
                                <input type="text" class="form-control" id="name_url" name="nama_url">
                            </div>
                            <div class="form-group">
                                <label for="nama_eselon">Nama Eselon:</label>
                                <input type="text" class="form-control" id="nama_eselon" name="nama_eselon">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <span style="margin: 25px">
                            ...
                            <a href="{{url('/deskripsi')}}" type="reset" class="btn btn-md btn-danger">Batal</a>
                        </span>
                    </div>
                    </form>
            </div>
