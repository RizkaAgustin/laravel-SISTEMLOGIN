        ...
        <section class="content">-->
                ...
                <section class="main-section">
                    ...
                    <div class="content">
                        ...
                        @endif
                        <form action="{{url('/tambahdeskripsisi/create')}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="nama_url">Nama URL:</label>
                                <input type="text" class="form-control" id="name_url" name="nama_url" placeholder="Nama Url" value="{{old('nama_url')}}">
                            </div>
                            <input type="hidden" name="id_eselon1" value="{{$eselon1->id}}">
                            <input type="hidden" name="id_kategori_si" value="1">
                            <div class="form-group">
                                <label for="nama_eselon">Nama Eselon:</label>
                                <input type="text" class="form-control" id="nama_eselon" name="nama_eselon" value="{{$eselon1->nama_eselon1}}">
                            </div>
                            <div class="form-group">
                                <label for="deskripsi">Deskripsi:</label>
                                <textarea name="deskripsi" rows="5" class="form-control" id="deskripsi" placeholder="Deskripsi..">{{{ Request::old('deskripsi') }}}</textarea>
                            </div>
                            <!--<div class="form-group">
