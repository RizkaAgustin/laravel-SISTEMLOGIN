...
<a>
    ...
    <head>
        ...
        <title>Monitoring | kategori</title>
        ...
        /.sidebar -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Pengelolaan Hutan Dan Produksi Lestari
                        <small>Kementerian Lingkungan Hidup dan Kehutanan</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                        <li class="active">Pengelolaan Hutan Dan Produksi Lestari</li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="{{url('deskripsiweb/6')}}" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    ...
                                    <p>Sistem Informasi Menlhk</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-file-code-o"></i>
                                </div>
                                <a href="{{url('deskripsisi/6')}}" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- ./col -->
