            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <!--<div class="box">
                        ...
                        <button type="button" class="card text-white bg-lightseagreen mb-3" style="max-width: 18rem;">
                            <h1 class="card-header">Total Website</h1>
                            <div class="card-body">
                                <p class="card-title text-center">Website Sekretariat Jenderal
                            </div>
                            <h2 class="card-text">2345</h2>
                        </button>
                        <button type="button" class="card text-white bg-lightseagreen mb-3" style="max-width: 18rem;">
                            <h1 class="card-header">Total SI</h1>
                            <div class="card-body">
                                <p class="card-title text-center">SI Sekretariat Jenderal
                            </div>
                            <h2 class="card-text">2345</h2>
                        </button>
                        <div class="box-header with-border">
                            <div class="col-6">
                                <h1 class="box-title"><b>Deskripsi Web</b></h1>
                            </div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-6">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil"></i> Ubah
                                        </button>
                                    </div>-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text-justify">
                                ...
                                <thead>
                                    ...
                                    <a href="{{url('/tambahdeskripsiweb'.'/'.$id_eselon)}}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data
                                    </a><br><br>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama URL</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <li class="btn-left">
                                                <a href="{{url('/editdeskripsiweb'.'/'.$data->id)}}" class="btn btn-primary" onclick="return confirm('ingin ubah?');"><i class="fa fa-pencil"></i> Ubah</a>
                                            </li><br><br>
                                            <li class="btn-left">
                                                <!-- <form action="{{ $data->id_eselon1}}" method="POST" class="d-inline"> -->

                                                <a href="{{url('/deletedeskripsiweb'.'/'.$data->id. '/' . $data->id_eselon1)}}" class="btn btn-danger" onclick="return confirm('yakin?');"><i class="fa fa-trash"></i> Hapus</a>
